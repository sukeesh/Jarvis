...
class Memory:
    """
    Welcome to the Short-Term Memory Trainer! Here you can find all the
    functionalities of this plugin.
    Usage: Type memory, press enter and follow the instructions
    Functionalities: You can train your memory by recalling a random generated number.
    Find out how many digits you can remember
    """

    def __call__(self, jarvis, s):
        jarvis.say("Welcome to Memory Trainer.")
        jarvis.say("Here we will train you by giving you a number to remember in a specific time.")
        jarvis.say("Each time you succeed the number will increase by 1 digit.")
    ...
    def trainer(self, jarvis):
        ...
        while not lost:
            ...
            if guess == number:
                jarvis.say("Correct guess of " + str(len(number)) + " digit number")
            else:
