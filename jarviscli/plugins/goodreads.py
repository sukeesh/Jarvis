...
def goodreads(jarvis, s):
    ...
    jarvis.say(
        "		Type 5 to check current giveaways from authors and publishers", Fore.BLUE)
    ...
    if choice == '1':
        ...
        title = jarvis.input(
            "Tell me the title  or the ISBN of the book you are looking for:", Fore.GREEN)
        ...
        URL = "https://www.goodreads.com/search?q="
        title = jarvis.input(
            "Tell me the name of the author you are looking for:", Fore.GREEN)
        ...
        genre = jarvis.input(
            "Tell me the name of the genre you would like to see:", Fore.GREEN)
