                ...
                for stock in data['symbolsList']:
                    if (re.match(name.lower(), stock['name'].lower())):
                        ...
                        jarvis.say(stock['symbol'] + "\t\t" +
                                   stock['name'], Fore.GREEN)

                if not found:
                    jarvis.say("The given name could not be found\n", Fore.RED)
            except KeyError:
                jarvis.say(
                    "The endpoint is not working at the moment. Try again later", Fore.RED)
        else:
            jarvis.say(
                "Cannot find the name at this time. Try again later\n", Fore.RED)
    ...
    def get_profile(self, jarvis, symbol):
        ...
        if (resp.status_code == 200):
            ...
            if (not data):
                ...
                jarvis.say(" Company     : " +
                           data['profile']['companyName'], Fore.GREEN)
                jarvis.say(" Industry    : " +
                           data['profile']['industry'], Fore.GREEN)
                jarvis.say(" Sector      : " +
                           data['profile']['sector'], Fore.GREEN)
                jarvis.say(" Website     : " +
                           data['profile']['website'], Fore.GREEN)
                jarvis.say(" Exchange    : " +
                           data['profile']['exchange'], Fore.GREEN)
                jarvis.say(" Description : " +
                           data['profile']['description'], Fore.GREEN)
        ...
        if (resp.status_code == 200):
            ...
            if (not data):
                ...
                for key in data['financials'][0].keys():
                    jarvis.say(key + " => " +
                               data['financials'][0][key], Fore.GREEN)
        else:
            jarvis.say("Cannot find details for " + symbol, Fore.RED)
        ...
        if (resp.status_code == 200):
            ...
            if (not data):
                ...
                for gainer in data['mostGainerStock']:
                    jarvis.say(gainer['ticker'] + " | " +
                               gainer['companyName'], Fore.GREEN)
                    jarvis.say(
                        "Price: " + str(gainer['price']) + " | Change: " + str(gainer['changes']), Fore.GREEN)
                    jarvis.say(
                        "Percent gained: " + str(gainer['changesPercentage'])[1:-1] + "\n\n", Fore.GREEN)
        else:
        ...
        if (resp.status_code == 200):
            ...
            if (not data):
                ...
                for loser in data['mostLoserStock']:
                    jarvis.say(loser['ticker'] + " | " +
                               loser['companyName'], Fore.GREEN)
                    jarvis.say(
                        "Price: " + str(loser['price']) + " | Change: " + str(loser['changes']), Fore.GREEN)
                    jarvis.say(
                        "Percent lost: " + str(loser['changesPercentage'])[1:-1] + "\n\n", Fore.GREEN)
        else:
