...
def blackjack(jarvis,s):
    ...
    jarvis.say('-->To \'Hit\' is to ask for another card. To \'Stand\' is to hold your total and end your turn.',Fore.CYAN)
    ...
    while choice in "Yy":
        ...
        while dealersum<17 or (dealersum==17 and 11 in dealerhand) :#condition which determines if dealer hits or not.
