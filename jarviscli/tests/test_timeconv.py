...
class TimeconvTest(PluginTest):
    ...
    def test_0_ps2ns(self):
        ...
        self.assertEqual(convamount, 30)
    ...
    def test_11_mus2ns(self):
        ...
        to_unit = "ns"
        convamount = self.test.time_convert(Jarvis, amount, from_unit, to_unit)
        self.assertEqual(convamount, 30000)
    ...
    def test_14_min2s(self):
        ...
        to_unit = "s"
        convamount = self.test.time_convert(Jarvis, amount, from_unit, to_unit)
        self.assertEqual(convamount, 180)
    ...
    def test_15_h2min(self):
        ...
        to_unit = "min"
        convamount = self.test.time_convert(Jarvis, amount, from_unit, to_unit)
        self.assertEqual(convamount, 120)
    ...
    def test_16_d2h(self):
        ...
        to_unit = "h"
        convamount = self.test.time_convert(Jarvis, amount, from_unit, to_unit)
        self.assertEqual(convamount, 72)
    ...
    def test_17_wk2d(self):
        ...
        to_unit = "d"
        convamount = self.test.time_convert(Jarvis, amount, from_unit, to_unit)
        self.assertEqual(convamount, 14)
    ...
    def test_19_yr2mon(self):
        ...
        to_unit = "mon"
        convamount = self.test.time_convert(Jarvis, amount, from_unit, to_unit)
        self.assertEqual(convamount, 24)
    ...
    def test_21_h2ms(self):
        ...
        to_unit = "ms"
        convamount = self.test.time_convert(Jarvis, amount, from_unit, to_unit)
        self.assertEqual(convamount, 7200000)
