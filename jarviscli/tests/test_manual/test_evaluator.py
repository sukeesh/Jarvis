...
from plugins.evaluator import calc
...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_calc(self):
        ...
        calc(self.jarvis._api, "2 powER 7 PLUS (6.7 Minus 3) diVided BY 0.45 bY 3")
        sys.stdout.seek(0)
        ...
        sys.stdout = StringIO()
        calc(self.jarvis._api, "(1 pluS 9.1j)^3.14129 mINUS 2.712")
        sys.stdout.seek(0)
        output = sys.stdout.read().strip()
