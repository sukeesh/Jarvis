...
class InfoExtractor(object):
    ...
    def _download_xml(self, url_or_request, video_id,
        ...
        xml_string = self._download_webpage(
            url_or_request, video_id, note, errnote, fatal=fatal, encoding=encoding, data=data, headers=headers,
            query=query)
    ...
    def _extract_mpd_formats(self, mpd_url, video_id, mpd_id=None, note=None, errnote=None, fatal=True,
                             formats_dict={}):
        res = self._download_webpage_handle(
            mpd_url, video_id,
